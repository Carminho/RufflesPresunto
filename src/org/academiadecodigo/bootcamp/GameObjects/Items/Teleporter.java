...
public class Teleporter {
    ...
    private void usercodePosition(int number, double col) {
        switch (userCode.charAt(number)) {
            case '0':
                code[number] = new Picture(col * Position.CELL_SIZE, 4.9 * Position.CELL_SIZE, "numbers/0.png");
                code[number].draw();
                break;
            case '1':
                code[number] = new Picture(col * Position.CELL_SIZE, 4.9 * Position.CELL_SIZE, "numbers/1.png");
                code[number].draw();
                break;
            case '2':
                code[number] = new Picture(col * Position.CELL_SIZE, 4.9 * Position.CELL_SIZE, "numbers/2.png");
                code[number].draw();
                break;
            case '3':
                code[number] = new Picture(col * Position.CELL_SIZE, 4.9 * Position.CELL_SIZE, "numbers/3.png");
                code[number].draw();
                break;
            case '4':
                code[number] = new Picture(col * Position.CELL_SIZE, 4.9 * Position.CELL_SIZE, "numbers/4.png");
                code[number].draw();
                break;
            case '5':
                code[number] = new Picture(col * Position.CELL_SIZE, 4.9 * Position.CELL_SIZE, "numbers/5.png");
                code[number].draw();
                break;
            case '6':
                code[number] = new Picture(col * Position.CELL_SIZE, 4.9 * Position.CELL_SIZE, "numbers/6.png");
                code[number].draw();
                break;
            case '7':
                code[number] = new Picture(col * Position.CELL_SIZE, 4.9 * Position.CELL_SIZE, "numbers/7.png");
                code[number].draw();
                break;
            case '8':
                code[number] = new Picture(col * Position.CELL_SIZE, 4.9 * Position.CELL_SIZE, "numbers/8.png");
                code[number].draw();
                break;
            case '9':
                code[number] = new Picture(col * Position.CELL_SIZE, 4.9 * Position.CELL_SIZE, "numbers/9.png");
                code[number].draw();
                break;
            default:
